...
class GHConsoleRootViewController: UIViewController {
    ...
    func configTextView() {
        ...
        //mark- TODO
        textView.autoresizingMask = UIView.AutoresizingMask(rawValue: UIView.AutoresizingMask.flexibleWidth.rawValue|UIView.AutoresizingMask.flexibleHeight.rawValue)
